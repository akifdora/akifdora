...
```
## Languages
![Langs](https://skillicons.dev/icons?i=js,dart,flutter,php,c,cs,cpp,")
## Technologies
![Techs](https://skillicons.dev/icons?i=git,vim,bash,nodejs,mysql,sqlite,mongodb,discord,bots,wordpress,ps,ai,figma,xd,cloudflare")
